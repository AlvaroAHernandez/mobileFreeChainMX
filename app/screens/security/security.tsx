  ...
  const [myAlerts, setMyAlerts] = useState([
    {
      id: 1,
      type: 'Accidente',
      message: 'Choque en carretera nacional rumbo a Los Cabos km 73',
  ...
  const [communityAlerts, setCommunityAlerts] = useState([
    {
      ...
      user: 'Jose Juan',
      type: 'Incendio',
      message: 'Incendio leve cerca del taller mecánico central',
      date: '15/9/2025 11:45pm',
    },
  ]);
      ...
      <ThemedView style={gs.screen}>
        <ScrollView contentContainerStyle={gs.scrollContent}>
          ...
          <View style={{ marginTop: 16, paddingHorizontal: 20 }}>
            <ThemedText style={[gs.title, { fontSize: 20 }]}>
              Centro de Seguridad
            </ThemedText>
          ...
          <View
            style={[
              gs.card,
              { marginTop: 20, marginHorizontal: 20, backgroundColor: '#300' },
            ]}
          >
            <ThemedText
              style={[gs.textPrimary, { color: '#fff', fontWeight: '600' }]}
            >
              Alerta de Emergencia
            </ThemedText>
            <ThemedText
              style={[gs.textSecondary, { color: '#fff', marginTop: 6 }]}
            >
              Envía una alerta de emergencia a tus contactos y miembros del
              motoclub.
            </ThemedText>
            ...
            <TouchableOpacity
              style={[
                gs.primaryButton,
                { backgroundColor: '#D32F2F', marginTop: 14 },
              ]}
          ...
          {showNewAlert && (
            <View style={[gs.card, { marginTop: 20, marginHorizontal: 20 }]}>
              <ThemedText
                style={[gs.textPrimary, { fontWeight: '600', marginBottom: 8 }]}
              >
                Nueva Alerta de Emergencia
              </ThemedText>
              ...
              >
                <TouchableOpacity
                  style={[
                    gs.primaryButton,
                    { backgroundColor: '#D32F2F', flex: 1, marginRight: 6 },
                  ]}
                ...
                <TouchableOpacity
                  style={[
                    gs.primaryButton,
                    { backgroundColor: Colors.surface, flex: 1, marginLeft: 6 },
                  ]}
                  onPress={() => setShowNewAlert(false)}
                >
                  <Text style={[gs.primaryButtonText, { color: Colors.text }]}>
                    Cancelar
                  </Text>
                </TouchableOpacity>
              </View>
          ...
          <View style={{ marginTop: 20, paddingHorizontal: 20 }}>
            ...
            {myAlerts.map((alert) => (
              ...
              >
                ...
                <ThemedText
                  style={[gs.textMuted, { color: '#ccc', marginTop: 4 }]}
                >
                  {alert.date}
                </ThemedText>
              </View>
          ...
          <View
            style={{ marginTop: 20, paddingHorizontal: 20, marginBottom: 40 }}
          >
            <ThemedText style={gs.sectionTitle}>
              Alertas de la comunidad
            </ThemedText>
            ...
            {communityAlerts.map((alert) => (
              ...
              >
                ...
                <ThemedText
                  style={[gs.textSecondary, { marginTop: 6 }]}
                >
                  {alert.message}
                </ThemedText>
                <ThemedText
                  style={[gs.textMuted, { marginTop: 4 }]}
                >
                  {alert.date}
                </ThemedText>
              </View>
